...
- **Transparency documentation** - Microsoft publishes [Transparency Notes](https://learn.microsoft.com/en-us/legal/cognitive-services/openai/transparency-note) for AI services that explain how the technology works, its capabilities and limitations, and configuration choices that influence behavior
...
Brute force guessing for share nes:
...
If you have a user ne or guest login works:
```
$ smbclient //windows_server_NETBIOS_nE/destination_folder -U WINDOWS_USER -I x.x.x.x
```
or
```
...
```
$ smbget -R smb://x.x.x.x/Folder/ -U Userne
```

### Impacket 

```
python3 /usr/share/doc/python3-impacket/examples/smbclient.py userne@x.x.x.x
```

...
email=victim@mail.com&userne=sadvictim
```
...
Scour JavaScript files for variable nes then try each of them as a GET/POST parameters to uncover hidden parameters. This often results in XSS!

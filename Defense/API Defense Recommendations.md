...
# Input
 ...
 Use an API Gateway service to enable caching, Rate Limit policies (e.g., Quota, Spike Arrest, or Concurrent Rate Limit) and deploy APIs resources dynically.
...
• Locate admin endpoints
 ...
 If you are parsing XML, YAML or any other language with anchors and refs, make sure entity expansion is not enabled to avoid Billion Laulightbulb/XML bomb via exponential entity expansion attack.
...
# CI & CD
 ...
 Continuously run security tests (static/dynic analysis) on your code.
